...
if __name__ == '__main__':
    ...
    class_weights = [0.700, 0.246, 0.953, 3.654, 1.207, 13.229, 12.517, 5.039]

    # Run comprehensive evaluation
    print("\nRunning comprehensive evaluation...")
    results = evaluation.evaluate_model(trained_model, valid_dataset, class_names, class_weights)
    
    # Save evaluation results
    np.save(os.path.join(log_dir, 'evaluation_results.npy'), results)
